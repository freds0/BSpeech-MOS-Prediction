...
class WeightedEmbeddingsDataset(Dataset):
...
class WeightedEmbeddingsDataloader(DataLoader):
    def __init__(self, data_dir, metadata_file, val_metadata_file, emb_dir, train_batch_size, val_batch_size, shuffle=False):
        ...
        self.dataset = WeightedEmbeddingsDataset(train_filepaths, train_scores)
    ...
    def get_val_dataloader(self):
        ...
        self.val_dataset = WeightedEmbeddingsDataset(val_filepaths, val_scores)
